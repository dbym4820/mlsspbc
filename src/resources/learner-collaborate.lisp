...
(defpage learner-collaborate ()
  `(:ul :class "nav nav-tabs" :id "tabs"
	(:li :class "active"
	     (:a :href "#knowledge" :data-toggle "tab" "コンセプトマップ")))
  `(:div :id "myTabContent" :class "tab-content"
	 (:div :class "tab-pane fade in active" :id "knowledge"
	       ...
	       (:br)
	       ;; (:a :href "./correction" (:h1 "プレゼン設計を終了して協調学習に進む"))
	       (:button :class "finish-declare-btn" "プレゼン設計を終了して協調学習に進む")
	       (:br)))
