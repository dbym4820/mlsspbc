...
(defun knowledge-struct ()
  (let ((node-content (get-parameter "node-content"))
    ...
    (format nil "~A" "[{id: 1, label: 'Node 1', title: 'I have a popup!'},{id: 2, label: 'Node 2', title: 'I have a popup!'},{id: 3, label: 'Node 3', title: 'I have a popup!'},{id: 4, label: 'このノードはだめだ', title: 'I have a popup!'},{label: 'Node 5', title: 'I have a popup!'}]")))
