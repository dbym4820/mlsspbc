	       ...
	       (:div :id "c-window" :class "" ;; コンテンツパーツを置いているウィンドウ
		     ...
		     (:div :id "myTabContent" :class "tab-content"
			   ...
			   (:div :class "tab-pane fade" :id "slides"
				 ...
				 ;; (:div :id "slide-rows"
				       (:script
					"let html1 = slidePartsList();document.write(html1);")
					     (:div :id "slide-parts-container")
				       ;; ,(slide-getter (get-parameter "lesson-id"))
					     )
			   (:div :style "clear:both;"))))
	 (:button :id "finish-declare-btn" "Finish to Presentation Design Task") ;;終了宣言ボタン
	 (:button :type "button" :onclick "saveDatas(); saveSideLine();" "SAVE") ;;コンセプトマップのセーブボタン => 一段落したら，intro-js/portfolio.jsないに，確認後セーブ処理として移す（このボタンは消して，終了宣言ボタンと同期させる
